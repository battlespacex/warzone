...
// UPDATED: supports per-satellite model selection via `mod`
// UPDATED: supports separate size + rotation settings per model type
...
// Per-model visual settings
// You can change these values anytime without touching each satellite entry.
