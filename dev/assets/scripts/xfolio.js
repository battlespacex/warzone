...
function createCard(item, index, { eager = false } = {}) {
    ...
    button.innerHTML = "<span aria-hidden='true' class='aerocism-ico-open-1'></span>";
...
function createLightbox() {
    ...
    lightboxCloseBtn.innerHTML = "<span aria-hidden='true' class='aerocism-ico-close-1'></span>";
    ...
    lightboxPrevBtn.innerHTML = "<span aria-hidden='true' class='aerocism-ico-previous-1'></span>";
    ...
    lightboxNextBtn.innerHTML = "<span aria-hidden='true' class='aerocism-ico-next-1'></span>";
    ...
    lightboxDownloadBtn.innerHTML = `
        <span aria-hidden="true" class="aerocism-ico-download-1"></span>
