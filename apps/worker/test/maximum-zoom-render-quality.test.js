...
test("maximum zoom sharpens existing imagery without overlays or framebuffer resizing", () => {
    ...
    assert.doesNotMatch(globe, /maximumZoomResolutionScale/);
    ...
    assert.match(css, /--warzone-max-zoom-resolution-scale:\s*1/);
